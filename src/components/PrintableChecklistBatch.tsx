...
import type { VehicleChecklistData } from '../types';
      ...
      {data.map((record) => (
        <div key={record.id} className="batch-page" style={{ pageBreakAfter: 'always', width: '100%', padding: '0.5cm', boxSizing: 'border-box' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '10px' }}>
            ...
            <h1 style={{ fontSize: '20px', fontWeight: 900, color: 'black', textTransform: 'uppercase', letterSpacing: '2px', margin: '0 0 5px 0' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            ...
            <div className="batch-section">
              <h3 style={{ fontSize: '14px', color: 'black', margin: '0 0 5px 0', fontWeight: 800 }}>Información General de la Unidad</h3>
            ...
            <div className="batch-section">
              <h3 style={{ fontSize: '14px', color: 'black', margin: '0 0 5px 0', fontWeight: 800 }}>Ítems de Verificación</h3>
              <div className="batch-grid-4">
                {checkGroups.map((group) => (
                  <div key={group.title}>
                    <h4 style={{ color: 'black', borderBottom: '1px solid #CCC', paddingBottom: '2px', margin: '0 0 5px 0', fontSize: '12px' }}>
                      {group.title}
                    </h4>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
            ...
            <div className="batch-section">
              <h3 style={{ fontSize: '14px', color: 'black', margin: '0 0 5px 0', fontWeight: 800 }}>Vencimientos y Observaciones</h3>
              ...
              <div>
                ...
                <div className="batch-value" style={{ minHeight: '30px' }}>
              ...
              <div style={{ display: 'flex', marginTop: '20px', justifyContent: 'space-around' }}>
                <div style={{ textAlign: 'center' }}>
                  ...
                  <p style={{ margin: '2px 0 0 0', fontSize: '10px' }}><strong>{record.driver}</strong></p>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ width: '250px', borderBottom: '1px solid black', marginBottom: '5px' }}></div>
