...
const VehicleChecklistForm: React.FC<VehicleChecklistFormProps> = ({ onSave, onUpdate, onBack, lists, history, editData }) => {
  ...
  return (
    <div className="container checklist-container" style={{ paddingBottom: '4rem' }}>
      ...
      <div className="no-print" style={{ display: 'flex', gap: '1rem', marginBottom: '1rem', justifyContent: 'space-between' }}>
      ...
      <div className="glass print-area" style={{ padding: '3rem', borderTop: '4px solid #ff6600', boxShadow: '0 -5px 20px rgba(255,102,0,0.1)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }} className="print-header">
          ...
          <h1 style={{ fontSize: '2.5rem', fontWeight: 900, color: '#ff6600', textTransform: 'uppercase', letterSpacing: '2px', margin: 0 }}>
                    ...
                    {group.items.map((item) => {
                      ...
                      return (
                        <div 
                          ...
                          className="check-item no-print-bg"
                          style={{
